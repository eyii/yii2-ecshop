...
/**
 * AdPositionModelSearch represents the model behind the search form about `common\models\guanli_guanggao\AdPositionModel`.
 */
class AdPositionModelSearch extends AdPositionModel
{
    /**
     * @inheritdoc
     */
