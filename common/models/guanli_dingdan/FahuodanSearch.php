...
/**
 * FahuodanSearch represents the model behind the search form about `common\models\guanli_dingdan\FahuodanModel`.
 */
class FahuodanSearch extends FahuodanModel
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['delivery_sn', 'order_sn', 'invoice_no', 'shipping_name', 'action_user', 'consignee', 'address', 'sign_building', 'email', 'zipcode', 'tel', 'mobile', 'best_time', 'postscript', 'how_oos'], 'safe'],
