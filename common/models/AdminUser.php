 ...
 */
class AdminUser extends \common\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'last_ip' => Yii::t('app', '最近一次登录ip'),
            'is_online' => Yii::t('app', '是否在线'),
            'domain_account' => Yii::t('app', '域账号'),
            'status' => Yii::t('app', '状态'),
            'create_user' => Yii::t('app', '创建人'),
            'create_date' => Yii::t('app', '创建时间'),
            'update_user' => Yii::t('app', '更新人'),
