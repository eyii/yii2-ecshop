 ...
 * @date 2015-08-24
 */
namespace common\models\weixinpay;
...
class Wxpay {
	...
	{
        $config = array(
            'appid' => "wx2871d7d8ea7b9407",    		/*微信开放平台上的应用id*/
            'mch_id' => "5e1c5022987515f39df9a4bfc60feddf",   		/*微信申请成功之后邮件中的商户id*/
            'api_key' => "5e1c5022987515f39df9a4bfc60feddf",    /*在微信商户平台上自己设定的api密钥 32位*/
        );
