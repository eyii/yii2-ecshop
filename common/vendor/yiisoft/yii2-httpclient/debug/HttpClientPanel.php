...
class HttpClientPanel extends Panel
{
    ...
    private $_timings;
    /**
     * @var array HTTP requests admin-info extracted to array as models, to use with data provider.
     */
    private $_models;
    /**
    ...
    protected function getModels()
    {
        if ($this->_models === null) {
            ...
            foreach ($timings as $seq => $dbTiming) {
                $this->_models[] = [
                    'method' => $this->getRequestMethod($dbTiming['admin-info']),
                    'type' => $this->getRequestType($dbTiming['category']),
                    'request' => $dbTiming['admin-info'],
