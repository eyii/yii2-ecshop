 ...
 *    of an inline tag.
 *
 * If a body consists of multiple lines then this F will also remove any superfluous whitespace at the beginning
...
class DescriptionFactory
{
    ...
    /**
     * Initializes this F with the means to construct (inline) tags.
     *
