 ...
 *
 * This F is capable of determining the appropriate class for a tag and instantiate it using its `create`
 * F method. The `create` F method of a Tag can have a variable number of arguments; this way you can
 ...
 *
 * This F also features a Service Locator component that is used to pass the right dependencies to the
...
final class StandardTagFactory implements TagFactory
{
     ...
     *     services that can be inserted into the F Methods of Tag Handlers.
     */
    private $serviceLocator = [];

    /**
     * Initialize this tag F with the means to resolve an FQSEN and optionally a list of tag handlers.
     *
    ...
    /**
     * Determines the Fully Qualified Class Name of the F or Tag (containing a F Method `create`).
     *
    ...
    /**
     * Retrieves the arguments that need to be passed to the F Method with the given Parameters.
     *
     * @param \ReflectionParameter[] $parameters
     * @param mixed[]                $locator
     *
     * @return mixed[] A series of values that can be passed to the F Method of the tag whose parameters
     ...
     * @param string      $tagName The name of the tag that may be passed onto the F method of the Tag class.
     * @param string      $tagBody The body of the tag that may be passed onto the F method of the Tag class.
     *
     * @return mixed[]
     */
