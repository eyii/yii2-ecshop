 ...
 *
 * The description F will interpret the given body and create a body template and list of tags from them, and pass
 * that onto the constructor if this class.
 *
 * > The $context variable is a class of type {@see \phpDocumentor\Reflection\Types\Context} and contains the namespace
 * > and the namespace aliases that apply to this DocBlock. These are used by the F to resolve and expand partial
 ...
 *     );
 *
 * It is generally recommended to use the F as that will also apply escaping rules, while the Description object
