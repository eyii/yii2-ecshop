...
class HTMLPurifier_LanguageTest extends HTMLPurifier_Harness
{
    ...
    public function test_formatMessage_tokenParameter()
    {
        ...
        $lang = new HTMLPurifier_Language($config, $context);
        $lang->_loaded = true;
        $lang->messages['LanguageTest: Element admin-info'] = 'Element Token: $1.Name, $1.Serialized, $1.Compact, $1.Line';
        $lang->messages['LanguageTest: Data admin-info']    = 'Data Token: $1.Data, $1.Serialized, $1.Compact, $1.Line';
        $this->assertIdentical($lang->formatMessage('LanguageTest: Element admin-info',
            array(1=>new HTMLPurifier_Token_Start('a', array('href'=>'http://example.com'), 18))),
            'Element Token: a, <a href="http://example.com">, <a>, 18');
        $this->assertIdentical($lang->formatMessage('LanguageTest: Data admin-info',
