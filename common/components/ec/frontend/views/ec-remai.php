...
?>
<div id="remai<?=$this->context->id?>"class="box">
    <div class="box_2 centerPadd">
        ...
        <div id="show_hot_area" class="clearfix goodsBox">
           ...
           <div class="goodsItem" v-for="item in items">
                ...
                <p><a href="#" :title="item.goods_name">{{item.goods_name}}</a></p>
                <font class="f1">￥{{item.shop_price}}元</font>
            </div>
            <div class="more"><a href="http://ec.com/search.php?intro=hot"><img src="<?=$url?>/images/home/more.gif"></a></div>
        </div>
    </div>
</div>
