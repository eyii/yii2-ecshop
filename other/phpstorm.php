...
class phpstorm
{
    ...
    public function 自动代码(){
        return 'ALT+回车  导入包,自动修正
                CTRL+ALT+L  格式化代码
                CTRL+ALT+I  自动缩进
                CTRL+ALT+O  优化导入的类和包
                CTRL+E  最近更改的文件/代码
    ...
    public function 高亮(){
        return 'CTRL+F   选中的文字,高亮显示 上下跳到下一个或者上一个
                F2（Shift+F2） 高亮错误或警告快速定位
                SHIFT+F2  高亮错误或警告快速定位
                CTRL+SHIFT+F7  高亮显示多个关键字. ';
    }
    public function 本地历史VCSSVN(){
       return 'Alt +反引号（\'） 快速弹出VCS菜单
                Ctrl + K         提交项目VCS
                Ctrl + T         更新项目从VCS
                Alt + Shift + C  查看最近发生的变化';
    }
    public function 运行(){
        return 'Alt + Shift + F10  选择的配置和运行
    ...
    public function 导航(){
        return 'Shift + Esc键隐藏活动或最后一个激活的窗口
    ...
    public function 书签(){
        return 'Ctrl + F11切换书签助记符
                Ctrl +＃[0-9]转到编号书签
                Shift + F11显示书签';
    }
    public function 编辑(){
        return 'Ctrl + Q      快速文档查询
