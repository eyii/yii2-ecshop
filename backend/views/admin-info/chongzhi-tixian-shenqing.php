...
<!-- saved from url=(0045)http://ec.com/admin/user_account.php?act=list -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>ECSHOP 管理中心 - 充值和提现申请 </title>
<meta name="robots" content="noindex, nofollow">

<link href="./chongzhi-tixian-shenqing_files/general.css" rel="stylesheet" type="text/css">
<link href="./chongzhi-tixian-shenqing_files/main.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="./chongzhi-tixian-shenqing_files/transport.js"></script><script type="text/javascript" src="./chongzhi-tixian-shenqing_files/common.js"></script><script language="JavaScript">
<!--
// 这里把JS用到的所有语言都赋值到这里
...
<h1>
<span class="action-span"><a href="http://ec.com/admin/user_account.php?act=add">添加申请</a></span>
<span class="action-span1"><a href="http://ec.com/admin/index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 充值和提现申请 </span>
<div style="clear:both"></div>
</h1>
<script type="text/javascript" src="./chongzhi-tixian-shenqing_files/utils.js"></script><script type="text/javascript" src="./chongzhi-tixian-shenqing_files/listtable.js"></script><div class="form-div">
  <form action="javascript:searchUser()" name="searchForm">
    <img src="./chongzhi-tixian-shenqing_files/icon_search.gif" width="25" height="22" border="0" alt="SEARCH">
    会员名称 <input type="text" name="keyword" size="10">
      ...
      <option value="余额支付">余额支付</option><option value="银行汇款/转帐">银行汇款/转帐</option>      </select>
      <select name="is_paid">
...
<table cellpadding="3" cellspacing="1">
  <tbody><tr>
    ...
    <th><a href="javascript:listTable.sort(&#39;add_time&#39;, &#39;DESC&#39;); " title="点击对列表排序">操作日期</a></th>
    ...
    <tr>
    <td class="no-records" colspan="8" style="background-color: rgb(255, 255, 255);">没有找到任何记录</td>
  </tr>
  
</tbody></table><table id="page-table" cellspacing="0">
<tbody><tr>
...
<div id="footer">
共执行 4 个查询，用时 0.007000 秒，Gzip 已禁用，内存占用 1.115 MB<br>
