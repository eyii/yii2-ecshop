...
<!-- saved from url=(0036)http://ec.com/admin/ads.php?act=list -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>ECSHOP 管理中心 - 广告列表 </title>
<meta name="robots" content="noindex, nofollow">

<link href="./guanggao-list_files/general.css" rel="stylesheet" type="text/css">
<link href="./guanggao-list_files/main.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="./guanggao-list_files/transport.js"></script><script type="text/javascript" src="./guanggao-list_files/common.js"></script><script language="JavaScript">
<!--
// 这里把JS用到的所有语言都赋值到这里
...
<h1>
<span class="action-span"><a href="http://ec.com/admin/ads.php?act=add">添加广告</a></span>
<span class="action-span1"><a href="http://ec.com/admin/index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 广告列表 </span>
<div style="clear:both"></div>
</h1>
<script type="text/javascript" src="./guanggao-list_files/utils.js"></script><script type="text/javascript" src="./guanggao-list_files/listtable.js"></script>
...
<table cellpadding="3" cellspacing="1">
  <tbody><tr>
    <th><a href="javascript:listTable.sort(&#39;ad_name&#39;); ">广告名称</a><img src="./guanggao-list_files/sort_desc.gif"></th>
...
<div id="footer">
共执行 3 个查询，用时 0.070004 秒，Gzip 已禁用，内存占用 1.177 MB<br>
