...
use yii\helpers\Url;
$modelLabel = new \common\models\guanli_quanxian\AdminLog();
?>
	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div id="controller_id_div" class="form-group">
              <label for="controller_id" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("controller_id")?></label>
              <div class="col-sm-10">
          ...
          <div id="action_id_div" class="form-group">
              <label for="action_id" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("action_id")?></label>
              <div class="col-sm-10">
          ...
          <div id="url_div" class="form-group">
              <label for="url" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("url")?></label>
              <div class="col-sm-10">
          ...
          <div id="module_name_div" class="form-group">
              <label for="module_name" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("module_name")?></label>
              <div class="col-sm-10">
          ...
          <div id="func_name_div" class="form-group">
              <label for="func_name" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("func_name")?></label>
              <div class="col-sm-10">
          ...
          <div id="right_name_div" class="form-group">
              <label for="right_name" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("right_name")?></label>
              <div class="col-sm-10">
          ...
          <div id="client_ip_div" class="form-group">
              <label for="client_ip" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("client_ip")?></label>
              <div class="col-sm-10">
          ...
          <div id="create_user_div" class="form-group">
              <label for="create_user" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("create_user")?></label>
              <div class="col-sm-10">
          ...
          <div id="create_date_div" class="form-group">
              <label for="create_date" class="col-sm-2 control-label"><?=$modelLabel->getAttributeLabel("create_date")?></label>
              <div class="col-sm-10">
