...
use Yii;
use common\models\guanli_quanxian\AuthItemModel;
use common\models\guanli_quanxian\AuthItemSearch;

use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdminAuthItemController implements the CRUD actions for AuthItemModel model.
 */
class AdminAuthItemController extends BaseController
{
    /**
     * @inheritdoc
     */
