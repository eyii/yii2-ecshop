...
use common\models\guanli_shangpin\GoodsTypeSearch;

use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AdminGoodsTypeController implements the CRUD actions for GoodsTypeModel model.
 */
class AdminGoodsTypeController extends BaseController
{
    /**
     * @inheritdoc
     */
